...
<section class="content gallery pad1">
    <div class="container">
        <div class="row">
            ...
            <#--&lt;#&ndash;<td><a href="/bartender/${bartender.id}">${bartender.drinkName}</a></td>&ndash;&gt;-->
            <#--&lt;#&ndash;<td><a href="/bartender/${bartender.id}"><img src="${bartender.drinkImageUrl}" class="img-circle" width="304" height="236"></a></td>&ndash;&gt;-->
            <#--&lt;#&ndash;<td>${bartender.drinkIngredients}</td>&ndash;&gt;-->
            <#--&lt;#&ndash;</tr>&ndash;&gt;-->
            <#--</#list>-->
